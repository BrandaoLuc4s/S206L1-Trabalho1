...
describe('Criando cenário de teste para o site engoo', () => {
  ...
  it.skip('Caso de teste: Testando a seleção de Materiais', ()=> {
    cy.visit('https://engoo.com.br/app/daily-news')
    cy.get('[href="/app/materials"]').click()
    cy.get('.css-4rnjer > span').contains('materiais')
  })

  it.skip('Caso de teste: Tentando registrar um usuário no site com falha(nao aceitar os termos de serviço e Politíca de privacidade) e conferir se o a mensagem de erro aparece(Você deve concordar com os termos de serviço para criar uma conta.)', () => {
    cy.visit('https://engoo.com.br/app/daily-news')
  ...
  it.skip('Caso de teste: Testanto o mecanismo de busca para os textos não encontrados, refente a palavra pesquisada)', () => {
    cy.visit('https://engoo.com.br/app/daily-news')
    cy.get('.css-1gdc72y').type('Inatel{enter}')
    cy.get('.css-uvdrtt > div').should('have.text', 'Nenhum artigo encontrado')
  })

  it.skip('Caso de teste: Testanto se o primeiro texto encontrado possui a palavra desejada do mecanismo de pesquisa)', () => {
    cy.visit('https://engoo.com.br/app/daily-news')
  ...
  it.skip('Caso de teste: Testando se o genero textual do texto está correto)', ()=> {
    cy.visit('https://engoo.com.br/app/daily-news')
